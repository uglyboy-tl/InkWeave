...
describe('ExternalFunctions', () => {
	...
	describe('bind', () => {
		it('should bind function to story', () => {
			...
			ExternalFunctions.bind(ink as unknown as Parameters<typeof ExternalFunctions.bind>[0], 'test');
		...
		it('should handle undefined function', () => {
			...
			ExternalFunctions.bind(ink as unknown as Parameters<typeof ExternalFunctions.bind>[0], 'nonexistent');
