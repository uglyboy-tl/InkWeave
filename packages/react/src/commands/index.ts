...
export class Commands {
  ...
  private static _default_translations: Record<string, string> = {
    close: "Close",
  ...
  static addTranslations(dict: Record<string, string>) {
    Object.assign(Commands._default_translations, dict);
  }

  static getTranslations(key: string) {
    return Commands._default_translations[key];
  }
}
