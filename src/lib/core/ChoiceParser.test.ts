...
import { ChoiceParser, Choice } from './ChoiceParser';
...
describe('ChoiceParser', () => {
	...
	describe('add', () => {
		...
		it('should register component', () => {
			...
			ChoiceParser.add('custom', vi.fn(), Component);
			expect(ChoiceParser.components.has('custom')).toBe(true);
		});
	});
	...
	describe('clear', () => {
		...
		it('should clear components', () => {
			ChoiceParser.add('custom', vi.fn(), () => null);
			ChoiceParser.clear();
			expect(ChoiceParser.components.has('custom')).toBe(false);
		});
	});
});